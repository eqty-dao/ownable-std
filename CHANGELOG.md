...
## [0.9.0](https://github.com/eqty-dao/ownable-std/compare/ownable-std-v0.8.0...ownable-std-v0.9.0) - 2026-06-28

### Added

- add dossier attachment and close surface

### Other

- Merge pull request #14 from eqty-dao/feat/dossier
- add macro regression coverage
